...
export default async function DashboardPage() {
  ...
  return (
    <div className="flex flex-col">
      <Header title="Dashboard" description={`Bienvenido, ${profile?.username || "Usuario"}`} />
      ...
      <div className="flex-1 space-y-6 p-4 md:p-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{formatCurrency(totalBalance, userCurrency)}</div>
              <p className="text-xs text-muted-foreground">{accounts?.length || 0} cuentas activas</p>
            </CardContent>
          </Card>
